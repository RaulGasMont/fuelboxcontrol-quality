package com.gasmonsoft.fbccalidad.data.service.firmware

import android.bluetooth.BluetoothGattCharacteristic
import android.util.Log
import com.gasmonsoft.fbccalidad.data.model.ble.CONTROL_FIRMWARE_UUID
import com.gasmonsoft.fbccalidad.data.model.ble.DATA_FIRMWARE_UUID
import com.gasmonsoft.fbccalidad.data.model.ble.SERVICE_FIRMWARE_UUID
...
class ProFileSender @Inject constructor(
    ...
    fun setMtuAndGatt(mtu: Int) {
        ...
        val service = bleConnectionManager.currentGatt()?.getService(SERVICE_FIRMWARE_UUID) ?: return
